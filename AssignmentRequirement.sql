...
ALTER ROLE TournamentOrganizer ADD MEMBER TO1;
ALTER ROLE TournamentOrganizer ADD MEMBER TO2;

CREATE LOGIN IC1 with Password='123';
CREATE USER IC1 FOR LOGIN IC1;
CREATE USER TC2 WITHOUT LOGIN;
ALTER ROLE IndividualCustomer ADD MEMBER IC1;
